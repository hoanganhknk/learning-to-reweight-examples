...
# Dùng TF1-compat để có string_input_producer, Queue, batch_join, ...
...
class InputPipeline(object):
    ...
    def inputs(self,
        ...
        # Force all input processing onto CPU to reserve GPU for training.
    ...
    def _inputs(self, num_epochs, num_preprocess_threads, num_readers, queue_memory_factor,
        ...
        """
        Constructs batches of training or evaluation examples from the image dataset.
        """
        ...
        with tf.name_scope('batch_processing'):
            ...
            if num_preprocess_threads % 4:
                raise ValueError('Please make num_preprocess_threads a multiple of 4 '
                                 f'({num_preprocess_threads} % 4 != 0).')
            ...
            # Size the random shuffle queue (see original comments).
